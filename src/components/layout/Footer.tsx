          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-8">
            ...
            <div className="lg:col-span-4">
              ...
              <div className="flex items-center gap-4">
                <a <a href="https://www.instagram.com/hipervinculo_" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors"> target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
