export const avNutraceuticalsProposalContent = {
  ...
  investment: {
    ...
    ongoing: {
      ...
      note: 'The hybrid model is BOTH amounts together: the $2,500 monthly fee is charged every month, and the 10% commission is charged only when there is positive net profit.',
    },
    example: {
      ...
      monthlyFee: { label: 'Monthly Management Fee', value: '$2,500' },
      commission: { label: 'Performance Commission (10%)', value: '$1,500' },
      total: { label: 'Total Hipervínculo Compensation', value: '$4,000' },
      note: 'All figures are sourced directly from Sellerise. The net profit number displayed in Sellerise is the definitive figure used to calculate the 10% commission each month, on top of the fixed $2,500 monthly fee.',
  ...
  terms: {
    ...
    sections: [
      ...
      },
      {
        ...
        description: 'The $2,500 monthly management fee is invoiced at the beginning of each month and is due 100% upfront before that month\'s services are delivered.',
        icon: 'dollar',
      },
      {
    ...
    sections: [
      {
        ...
        items: [
          ...
          'If net profit is zero or negative in any given month, no commission is charged for that period — but the $2,500 monthly fee still applies.',
