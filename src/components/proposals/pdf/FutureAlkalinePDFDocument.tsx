...
export function FutureAlkalinePDFDocument({ logoBase64 }: Props) {
  ...
  return (
    <Document>
      ...
      <Page size="A4" style={s.page}>
        ...
        <Text style={{ fontSize: 11, fontWeight: 'bold', color: lime, marginBottom: 12 }}>{content.googleAdsService.headline}</Text>
        <View style={{ backgroundColor: green, borderRadius: 14, paddingHorizontal: 24, paddingVertical: 14, marginBottom: 12 }}>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
            ...
            <Text style={{ fontSize: 28, fontWeight: 'bold', color: 'white' }}>{content.googleAdsService.retainer}</Text>
          </View>
          <View style={{ borderTopWidth: 0.5, borderTopColor: 'rgba(255,255,255,0.1)', paddingTop: 8, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
            <View>
              ...
              <Text style={{ fontSize: 7, color: 'rgba(255,255,255,0.4)', marginTop: 2 }}>{content.googleAdsService.mediaSpendNote}</Text>
            </View>
            <Text style={{ fontSize: 20, fontWeight: 'bold', color: 'white' }}>{content.googleAdsService.mediaSpend}</Text>
          </View>
        </View>
        <Text style={{ fontSize: 10, color: gray, lineHeight: 1.6, marginBottom: 10 }}>{content.googleAdsService.description}</Text>
      ...
      <Page size="A4" style={s.page}>
        <View style={s.accent} />
        <Text style={{ fontSize: 9, fontWeight: 'bold', color: lime, letterSpacing: 3, marginBottom: 6 }}>SERVICIO 3</Text>
      ...
      <Page size="A4" style={s.page}>
        <View style={s.accent} />
        <Text style={{ fontSize: 9, fontWeight: 'bold', color: lime, letterSpacing: 3, marginBottom: 6 }}>SERVICIO 4</Text>
        ...
        <View style={{ flexDirection: 'row', gap: 14, marginBottom: 20 }}>
          ...
          <View style={{ flex: 1, backgroundColor: 'white', borderRadius: 14, padding: 20 }}>
            ...
            {content.investment.setup.items.map((item, i) => (
              <View key={i} style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10 }}>
                ...
                <Text style={{ fontSize: 12, fontWeight: 'bold', color: green }}>{item.price}</Text>
              </View>
            ))}
            <View style={{ borderTopWidth: 0.5, borderTopColor: '#e5e7eb', paddingTop: 10, marginTop: 6, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
              <Text style={{ fontSize: 10, fontWeight: 'bold', color: green }}>Total Inicial</Text>
          ...
          <View style={{ flex: 1, backgroundColor: 'white', borderRadius: 14, padding: 20 }}>
            ...
            <View style={{ borderTopWidth: 0.5, borderTopColor: '#e5e7eb', paddingTop: 10, marginTop: 6 }}>
              <Text style={{ fontSize: 8, color: grayLight, lineHeight: 1.5 }}>{content.investment.monthly.mediaNote}</Text>
            </View>
          </View>
        </View>
