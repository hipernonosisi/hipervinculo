...
import { RamotarPeptidePDFDocument } from './pdf/RamotarPeptidePDFDocument';
...
export function RamotarPeptideProposal() {
  ...
  const handleDownloadPDF = useCallback(async () => {
    ...
    try {
      ...
      const blob = await pdf(
        <RamotarPeptidePDFDocument logoBase64={logoBase64} />
      ).toBlob();
