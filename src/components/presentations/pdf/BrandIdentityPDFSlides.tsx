...
import { BrandIdentityContent } from '../data/brandIdentityPresentationContent';
...
const styles = StyleSheet.create({
  ...
  grid3: { flexDirection: 'row', flexWrap: 'wrap', gap: 24 },
  ...
  problemCard: { backgroundColor: colors.white, borderRadius: 16, padding: 24, flexDirection: 'row', alignItems: 'flex-start' },
  ...
  iconBoxSmall: { width: 44, height: 44, borderRadius: 10, backgroundColor: colors.limeGreenLight, alignItems: 'center', justifyContent: 'center' },
  // Process
...
// Cover
const CoverSlidePDF = ({ content, logoBase64 }: { content: BrandIdentityContent['cover']; logoBase64: string }) => (
...
// About
const AboutSlidePDF = ({ content, logoBase64 }: { content: BrandIdentityContent['about']; logoBase64: string }) => (
  <Page size={[1920, 1080]} style={styles.page}>
...
// Problem
const ProblemSlidePDF = ({ content, logoBase64 }: { content: BrandIdentityContent['problem']; logoBase64: string }) => (
  <Page size={[1920, 1080]} style={styles.page}>
    <SlideHeader logoBase64={logoBase64} />
    <Text style={styles.title}>{content.title}</Text>
...
// Solution
const SolutionSlidePDF = ({ content, logoBase64 }: { content: BrandIdentityContent['solution']; logoBase64: string }) => (
  <Page size={[1920, 1080]} style={styles.page}>
    <SlideHeader logoBase64={logoBase64} />
    <Text style={styles.title}>{content.title}</Text>
...
// Process
const ProcessSlidePDF = ({ content, logoBase64 }: { content: BrandIdentityContent['process']; logoBase64: string }) => (
  <Page size={[1920, 1080]} style={styles.page}>
    <SlideHeader logoBase64={logoBase64} />
    <Text style={styles.title}>{content.title}</Text>
    <View style={[styles.grid2, { flexWrap: 'wrap', gap: 28, flex: 1 }]}>
...
// Pricing
const PricingSlidePDF = ({ content, logoBase64 }: { content: BrandIdentityContent['pricing']; logoBase64: string }) => (
  <Page size={[1920, 1080]} style={styles.page}>
    <SlideHeader logoBase64={logoBase64} />
    <Text style={styles.title}>{content.title}</Text>
    <Text style={styles.headline}>{content.headline}</Text>
...
// Other Services
const OtherServicesSlidePDF = ({ content, logoBase64 }: { content: BrandIdentityContent['otherServices']; logoBase64: string }) => (
  <Page size={[1920, 1080]} style={styles.page}>
    <SlideHeader logoBase64={logoBase64} />
    <Text style={styles.title}>{content.title}</Text>
    <Text style={styles.headline}>{content.headline}</Text>
...
// Contact
const ContactSlidePDF = ({ content, logoBase64 }: { content: BrandIdentityContent['contact']; logoBase64: string }) => (
...
// Main PDF Document
interface BrandIdentityPDFDocumentProps {
  content: BrandIdentityContent;
  logoBase64: string;
  symbolBase64: string;
}

export const BrandIdentityPDFDocument = ({ content, logoBase64 }: BrandIdentityPDFDocumentProps) => (
  <Document>
