...
import { LandingPageContent } from '../data/landingPagePresentationContent';
...
const styles = StyleSheet.create({
  ...
  // WhatIsIt
  definitionBox: { backgroundColor: colors.white, borderRadius: 16, padding: 32, marginBottom: 28 },
  definitionText: { fontSize: 28, color: colors.gray, lineHeight: 1.5 },
  keyPointItem: { flexDirection: 'row', alignItems: 'flex-start', marginBottom: 14 },
  keyPointText: { fontSize: 24, color: colors.gray, marginLeft: 14, flex: 1 },
  notIncludedItem: { flexDirection: 'row', alignItems: 'flex-start', marginBottom: 14 },
  notIncludedText: { fontSize: 24, color: colors.redDark, marginLeft: 14, flex: 1 },
});
...
// Cover
const CoverSlidePDF = ({ content, logoBase64 }: { content: LandingPageContent['cover']; logoBase64: string }) => (
...
// About
const AboutSlidePDF = ({ content, logoBase64 }: { content: LandingPageContent['about']; logoBase64: string }) => (
  <Page size={[1920, 1080]} style={styles.page}>
...
// Problem
const ProblemSlidePDF = ({ content, logoBase64 }: { content: LandingPageContent['problem']; logoBase64: string }) => (
  <Page size={[1920, 1080]} style={styles.page}>
    <SlideHeader logoBase64={logoBase64} />
    <Text style={styles.title}>{content.title}</Text>
...
// WhatIsIt
const WhatIsItSlidePDF = ({ content, logoBase64 }: { content: LandingPageContent['whatIsIt']; logoBase64: string }) => (
  <Page size={[1920, 1080]} style={styles.page}>
    <SlideHeader logoBase64={logoBase64} />
    <Text style={styles.title}>{content.title}</Text>
...
// Solution
const SolutionSlidePDF = ({ content, logoBase64 }: { content: LandingPageContent['solution']; logoBase64: string }) => (
  <Page size={[1920, 1080]} style={styles.page}>
    <SlideHeader logoBase64={logoBase64} />
    <Text style={styles.title}>{content.title}</Text>
    <Text style={styles.headline}>{content.headline}</Text>
...
// Process
const ProcessSlidePDF = ({ content, logoBase64 }: { content: LandingPageContent['process']; logoBase64: string }) => (
  <Page size={[1920, 1080]} style={styles.page}>
    <SlideHeader logoBase64={logoBase64} />
    <Text style={styles.title}>{content.title}</Text>
...
// Pricing
const PricingSlidePDF = ({ content, logoBase64 }: { content: LandingPageContent['pricing']; logoBase64: string }) => (
  <Page size={[1920, 1080]} style={styles.page}>
    <SlideHeader logoBase64={logoBase64} />
    <Text style={styles.title}>{content.title}</Text>
    <Text style={styles.headline}>{content.headline}</Text>
...
// Other Services
const OtherServicesSlidePDF = ({ content, logoBase64 }: { content: LandingPageContent['otherServices']; logoBase64: string }) => (
  <Page size={[1920, 1080]} style={styles.page}>
    <SlideHeader logoBase64={logoBase64} />
    <Text style={styles.title}>{content.title}</Text>
    <Text style={styles.headline}>{content.headline}</Text>
...
// Contact
const ContactSlidePDF = ({ content, logoBase64 }: { content: LandingPageContent['contact']; logoBase64: string }) => (
...
// Main Document
interface LandingPagePDFDocumentProps {
  content: LandingPageContent;
  logoBase64: string;
}

export const LandingPagePDFDocument = ({ content, logoBase64 }: LandingPagePDFDocumentProps) => (
  <Document>
    ...
    <WhatIsItSlidePDF content={content.whatIsIt} logoBase64={logoBase64} />
