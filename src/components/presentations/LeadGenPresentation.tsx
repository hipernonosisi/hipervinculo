...
export function LeadGenPresentation() {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 p-3 sm:p-4 bg-white border-b">
      ...
      {/* Slide viewer - Mobile: scrollable container with fixed slide size */}
      <div className="flex-1 min-h-0 overflow-auto bg-gray-100">
        <div className="flex items-start sm:items-center justify-center p-2 sm:p-4 md:p-8 min-h-full">
          <div 
            ref={containerRef}
      ...
      <div className="flex items-center justify-center gap-2 sm:gap-4 p-2 sm:p-4 bg-white border-t">
        <Button
          variant="outline"
          size="icon"
        ...
        {/* Slide dots - Smaller on mobile */}
        <div className="flex items-center gap-1 sm:gap-1.5 flex-wrap justify-center max-w-[200px] sm:max-w-none">
          {slides.map((_, index) => (
            <button
              key={index}
