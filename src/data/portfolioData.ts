...
export const portfolioProjects: PortfolioProject[] = [
  ...
  },
  {
    ...
    extraImages: ['/portfolio/stillwater-day-spa.png', '/portfolio/stillwater-day-spa-mobile.png'],
  ...
  },
  {
    ...
    overview: { en: 'Lajex LLC needed a clean, professional website to establish credibility and attract potential clients. We designed a modern site focused on clear service communication and trust-building elements.', es: 'Lajex LLC necesitaba un sitio web limpio y profesional para establecer credibilidad y atraer clientes potenciales. Diseñamos un sitio moderno enfocado en comunicación clara de servicios y elementos de construcción de confianza.' },
    servicesUsed: { en: ['Website Development', 'Brand Positioning'], es: ['Desarrollo Web', 'Posicionamiento de Marca'] },
    outcomes: [
