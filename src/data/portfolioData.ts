...
export const portfolioProjects: PortfolioProject[] = [
  // 1. Step Solution USA
  {
    ...
    description: { en: 'Custom stair treads & nosing manufacturer with lead generation and order collection system.', es: 'Fabricante de peldaños y narices personalizadas con sistema de generación de leads y recogida de pedidos.' },
    industry: { en: 'Manufacturing', es: 'Manufactura' },
    tagline: { en: 'A lead generation platform with intelligent forms and project management for a stair solutions manufacturer.', es: 'Una plataforma de generación de leads con formularios inteligentes y gestión de proyectos para un fabricante de soluciones de escaleras.' },
    overview: { en: 'Step Solution needed a digital platform to capture leads, collect orders, and manage projects internally. We built a conversion-focused website with multiple intelligent forms, an order collection system, and an admin dashboard to track and manage accumulated projects efficiently.', es: 'Step Solution necesitaba una plataforma digital para capturar leads, recoger pedidos y gestionar proyectos internamente. Construimos un sitio web enfocado en conversión con múltiples formularios inteligentes, sistema de recogida de pedidos y panel de administración para gestionar los proyectos acumulados eficientemente.' },
    servicesUsed: { en: ['Website Development', 'Lead Generation Systems', 'Custom Admin Dashboard'], es: ['Desarrollo Web', 'Sistemas de Generación de Leads', 'Panel de Administración Personalizado'] },
    outcomes: [
      { metric: '+320%', label: { en: 'Increase in qualified leads', es: 'Aumento en leads calificados' } },
  ...
  // 4. Pulverizadores Industriales (Reduction)
  {
    ...
    overview: { en: 'Reduction International needed a dedicated Spanish-language website to showcase their industrial pulverizers for the Latin American market. We built a platform with video integration, detailed equipment specifications, AI-powered product assistance, and a streamlined quote request flow.', es: 'Reduction International necesitaba un sitio web dedicado en español para mostrar sus pulverizadores industriales en el mercado latinoamericano. Construimos una plataforma con integración de video, especificaciones detalladas de equipos, asistente de producto con IA y un flujo optimizado de solicitud de cotización.' },
  ...
  // 8. Délios Home
  {
    ...
    overview: { en: 'Délios Home needed a high-converting landing page to capture consultation bookings for their premium kitchen renovation services in Madrid. We built a visually striking single-page experience featuring photorealistic 3D renders, a clear 4-step process, an embedded Calendly booking flow, testimonials with video, and WhatsApp integration — all designed to eliminate buyer anxiety and drive qualified meetings. We also launched a Meta Ads campaign targeting high-relevance audiences to drive qualified traffic to the landing page, generating 3 booked consultation calls within the first 24 hours.', es: 'Délios Home necesitaba una landing page de alta conversión para captar reservas de consultas para sus servicios premium de renovación de cocinas en Madrid. Construimos una experiencia visual de una sola página con renders 3D fotorrealistas, un proceso claro de 4 pasos, flujo de reservas con Calendly integrado, testimonios con video e integración de WhatsApp — todo diseñado para eliminar la ansiedad del comprador y generar reuniones calificadas. También lanzamos una campaña de Meta Ads dirigida a audiencias de alta relevancia para llevar tráfico calificado a la landing page, generando 3 llamadas de consulta agendadas en las primeras 24 horas.' },
    servicesUsed: { en: ['Landing Page Development', 'Conversion Optimization', 'Booking Integration', 'WhatsApp Integration', 'Meta Ads Campaign'], es: ['Desarrollo de Landing Page', 'Optimización de Conversión', 'Integración de Reservas', 'Integración de WhatsApp', 'Campaña de Meta Ads'] },
    outcomes: [
