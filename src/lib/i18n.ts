...
export const websiteScoreTranslations = {
  en: {
    ...
    results: {
      ...
      formBudget: "What's your approximate monthly budget for marketing?",
      budgetOptions: ['Less than $500', '$500-$1,500', '$1,500-$3,000', 'More than $3,000'],
      formTimeline: 'When would you like to get started?',
      timelineOptions: ['Immediately', 'Within 1 month', 'Within 3 months', 'Just exploring'],
      submitFinal: 'Request My Free Prototype',
    },
    thankYou: {
      title: 'Thank You!',
  ...
  es: {
    ...
    results: {
      ...
      formBudget: '¿Cuál es tu presupuesto mensual aproximado para marketing?',
      budgetOptions: ['Menos de $500', '$500-$1,500', '$1,500-$3,000', 'Más de $3,000'],
      formTimeline: '¿Cuándo te gustaría comenzar?',
      timelineOptions: ['Inmediatamente', 'Dentro de 1 mes', 'Dentro de 3 meses', 'Solo explorando'],
      submitFinal: 'Solicitar Mi Prototipo Gratis',
    },
    thankYou: {
      title: '¡Gracias!',
