...
export const websiteScoreTranslations = {
  en: {
    ...
    results: {
      ...
      roiText: "You're potentially losing ${revenue}/month. Our complete system costs $1,000/month to manage — that's a {multiplier}x return on investment.",
  ...
  es: {
    ...
    results: {
      ...
      roiText: 'Potencialmente estás perdiendo ${revenue}/mes. Nuestro sistema completo cuesta $1,000/mes de gestión — eso es un retorno de {multiplier}x sobre la inversión.',
