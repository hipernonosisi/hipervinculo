...
export const translations = {
  en: {
    ...
    about: {
      ...
      section1: {
        ...
        content: 'Every campaign we run is connected to your broader business goals. We obsess over your unit economics, understand your customer lifetime value, and optimize for actual profit — not vanity metrics.',
      },
      section2: {
        title: 'Built for Businesses That Want Stability',
        content: 'We\'re selective about who we work with because we want long-term partnerships, not quick wins. Our average client relationship is 2+ years. That\'s not by accident.',
      },
      problems: {
  ...
  es: {
    ...
    homepage: {
      ...
      provenResultsTitle: 'Resultados Comprobados en Canales de Crecimiento y Sistemas de Leads Inbound',
    ...
    about: {
      ...
      section1: {
        ...
        content: 'Cada campaña que ejecutamos está conectada a tus objetivos de negocio más amplios. Nos obsesionamos con tu economía unitaria, entendemos tu valor de vida del cliente y optimizamos para ganancias reales — no métricas de vanidad.',
      },
      section2: {
        title: 'Construido para Negocios que Quieren Estabilidad',
        content: 'Somos selectivos sobre con quién trabajamos porque queremos asociaciones a largo plazo, no victorias rápidas. Nuestra relación promedio con clientes es de 2+ años. Eso no es accidente.',
      },
      problems: {
