...
// Website Score translations - separate to keep main file manageable
export const websiteScoreTranslations = {
  en: {
    headline: 'Is Your Website Costing You Customers?',
    subtitle: 'Get your free Website Performance Score in 60 seconds. Find out if your site is helping or hurting your business.',
    questions: [
    ...
    analysis: {
      steps: [
        ...
        'Evaluating SEO fundamentals...',
        'Scanning for lead capture elements...',
    ...
    results: {
      ...
      average: 'Average',
      good: 'Good',
      industryAvg: 'Websites in the {businessType} industry average 62/100. Here\'s what we found:',
      yourScore: 'Your website scored',
      estimated: "We couldn't fully analyze your site's technical metrics at this time. The scores shown are industry averages for {businessType} businesses. Based on your industry data, we can already identify significant improvement opportunities.",
      technicalIssuesTitle: 'Potential Technical Issues',
      technicalIssuesDesc: "Your site may be blocking analysis tools or has technical issues that prevent proper scanning. This alone suggests configuration problems that could affect search visibility.",
      performance: 'Performance',
      performanceDesc: 'How fast your website loads and responds to user interactions.',
      seo: 'SEO',
      seoDesc: 'How well search engines can find and index your website.',
      accessibility: 'Accessibility',
      accessibilityDesc: 'How accessible your website is to all users, including those with disabilities.',
      bestPractices: 'Best Practices',
      bestPracticesDesc: 'Whether your website follows modern web development standards.',
      issuesTitle: 'Issues Detected & Opportunities',
      slowSite: 'Your site takes too long to load. 53% of visitors leave if a page takes more than 3 seconds.',
      poorSeo: "Search engines can't properly index your site. You're invisible to potential customers searching for your services.",
      poorAccessibility: 'Your site has accessibility issues that hurt both user experience and search rankings.',
      ...
      solutionFeatures: [
        'Professional website redesign optimized for lead generation',
        'Google Ads setup & management targeting customers searching for your services',
        'Lead tracking & attribution so you know exactly where leads come from',
        'Monthly optimization to continuously improve results',
      ],
      setupPrice: '$2,500',
      setupLabel: 'Website Development + Lead System Setup',
      monthlyPrice: '$1,000/month',
      monthlyLabel: 'Google Ads Management & Optimization',
      noContracts: 'No contracts — clients stay because the system works.',
      adBudgetNote: '* Recommended minimum Google Ads budget: $1,200/month (paid directly to Google, not to us)',
      roiText: "You're potentially losing ${revenue}/month in missed opportunities. For a total investment of $2,200/month ($1,000 management + $1,200 minimum ad budget), our clients typically see a {multiplier}x return. That's real leads calling your business.",
      ctaTitle: 'Want to See What Your New Website Would Look Like?',
      ctaText: "We'll build a free preview of your new website so you can see exactly what you'd get — before any commitment.",
      formName: 'Full Name',
      formPhone: 'Phone Number',
      formMvp: 'Want a Custom Preview of Your New Website?',
      mvpSteps: [
        { icon: '🎨', text: 'We design your site' },
        { icon: '📱', text: 'You preview it live' },
        { icon: '🚀', text: 'Launch when ready' },
      ],
      mvpExplanation: "Our team will build a working preview of your new website — tailored to your business, brand, and goals. You'll see exactly how it looks and feels before committing to anything. No cost for the preview. If you love it and want to move forward with development, we'll discuss pricing then.",
      mvpYes: 'Yes! Build my website preview',
      mvpNo: 'Not right now, just send me my report',
      submitFinal: 'Submit',
    },
    thankYou: {
      title: 'Thank You!',
      text: "Your request has been submitted. Our team will review your website score and reach out within 24 hours to discuss your free prototype.",
      backHome: 'Back to Home',
      exploreServices: 'Explore Our Services',
    },
  },
  es: {
    headline: '¿Tu Sitio Web Te Está Costando Clientes?',
    subtitle: 'Obtén tu Score de Rendimiento Web gratis en 60 segundos. Descubre si tu sitio está ayudando o perjudicando tu negocio.',
    questions: [
    ...
    analysis: {
      steps: [
        'Analizando la velocidad de tu sitio...',
        'Verificando responsividad móvil...',
        'Evaluando fundamentos SEO...',
        'Buscando elementos de captación de leads...',
        'Calculando tu score...',
      ],
    },
    results: {
      ...
      average: 'Promedio',
      good: 'Bueno',
      industryAvg: 'Los sitios web en la industria de {businessType} promedian 62/100. Esto es lo que encontramos:',
      yourScore: 'Tu sitio web obtuvo',
      estimated: 'No pudimos analizar completamente las métricas técnicas de tu sitio en este momento. Los scores mostrados son promedios de la industria para negocios de {businessType}. Basado en los datos de tu industria, ya podemos identificar oportunidades de mejora significativas.',
      technicalIssuesTitle: 'Posibles Problemas Técnicos',
      technicalIssuesDesc: 'Tu sitio podría estar bloqueando herramientas de análisis o tiene problemas técnicos que impiden un escaneo adecuado. Esto por sí solo sugiere problemas de configuración que podrían afectar la visibilidad en buscadores.',
      performance: 'Rendimiento',
      performanceDesc: 'Qué tan rápido carga tu sitio web y responde a las interacciones del usuario.',
      seo: 'SEO',
      seoDesc: 'Qué tan bien los motores de búsqueda pueden encontrar e indexar tu sitio web.',
      accessibility: 'Accesibilidad',
      accessibilityDesc: 'Qué tan accesible es tu sitio web para todos los usuarios, incluyendo aquellos con discapacidades.',
      bestPractices: 'Mejores Prácticas',
      bestPracticesDesc: 'Si tu sitio web sigue los estándares modernos de desarrollo web.',
      issuesTitle: 'Problemas Detectados y Oportunidades',
      slowSite: 'Tu sitio tarda demasiado en cargar. El 53% de los visitantes se van si una página tarda más de 3 segundos.',
      poorSeo: 'Los motores de búsqueda no pueden indexar bien tu sitio. Eres invisible para clientes potenciales buscando tus servicios.',
      poorAccessibility: 'Tu sitio tiene problemas de accesibilidad que afectan la experiencia del usuario y el ranking en buscadores.',
      ...
      solutionFeatures: [
        'Rediseño profesional de sitio web optimizado para generación de leads',
        'Configuración y gestión de Google Ads enfocado en clientes buscando tus servicios',
        'Seguimiento y atribución de leads para que sepas exactamente de dónde vienen',
        'Optimización mensual para mejorar resultados continuamente',
      ],
      setupPrice: '$2,500',
      setupLabel: 'Desarrollo de Sitio Web + Setup del Sistema de Leads',
      monthlyPrice: '$1,000/mes',
      monthlyLabel: 'Gestión y Optimización de Google Ads',
      noContracts: 'Sin contratos — los clientes se quedan porque el sistema funciona.',
      adBudgetNote: '* Presupuesto mínimo recomendado de Google Ads: $1,200/mes (pagado directamente a Google, no a nosotros)',
      roiText: 'Potencialmente estás perdiendo ${revenue}/mes en oportunidades perdidas. Con una inversión total de $2,200/mes ($1,000 gestión + $1,200 presupuesto mínimo de anuncios), nuestros clientes típicamente ven un retorno de {multiplier}x. Son leads reales llamando a tu negocio.',
      ctaTitle: '¿Quieres Ver Cómo Se Vería Tu Nuevo Sitio Web?',
      ctaText: 'Diseñaremos una vista previa gratuita de tu nuevo sitio web para que veas exactamente qué obtendrías — sin ningún compromiso.',
      formName: 'Nombre Completo',
      formPhone: 'Número de Teléfono',
      formMvp: '¿Quieres una Vista Previa Personalizada de Tu Nuevo Sitio Web?',
      mvpSteps: [
        { icon: '🎨', text: 'Diseñamos tu sitio' },
        { icon: '📱', text: 'Lo previsualizas en vivo' },
        { icon: '🚀', text: 'Lanza cuando quieras' },
      ],
      mvpExplanation: 'Nuestro equipo construirá una vista previa funcional de tu nuevo sitio web — adaptada a tu negocio, marca y objetivos. Verás exactamente cómo se ve y se siente antes de comprometerte a nada. La vista previa no tiene costo. Si te encanta y quieres avanzar con el desarrollo, hablamos de precios en ese momento.',
      mvpYes: '¡Sí! Construyan mi vista previa',
      mvpNo: 'Ahora no, solo envíame mi reporte',
      submitFinal: 'Enviar',
    },
    thankYou: {
      title: '¡Gracias!',
      text: 'Tu solicitud ha sido enviada. Nuestro equipo revisará el score de tu sitio web y te contactará en 24 horas para discutir tu prototipo gratis.',
