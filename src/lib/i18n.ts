...
export const websiteScoreTranslations = {
  en: {
    ...
    results: {
      ...
      estimated: 'Estimated scores based on industry averages for {businessType}.',
      ...
      ctaTitle: 'Want to See What Your New Website Could Look Like?',
      ctaText: "We'll build a free prototype of your new website so you can see exactly what you'd get — before any commitment.",
      formName: 'Full Name',
      formPhone: 'Phone Number',
      formMvp: 'Would you like us to build a free MVP for your business?',
      mvpExplanation: 'An MVP (Minimum Viable Product) is a simplified version of your website that shows how it would look and function — built specifically for your business. It\'s completely free and helps you visualize the end result before making any investment.',
      mvpYes: 'Yes, build me a free MVP!',
      mvpNo: 'Not right now, just send me the results',
      submitFinal: 'Submit',
    },
    thankYou: {
      title: 'Thank You!',
  ...
  es: {
    ...
    results: {
      ...
      estimated: 'Scores estimados basados en promedios de la industria para {businessType}.',
      ...
      ctaText: 'Construiremos un prototipo gratis de tu nuevo sitio web para que veas exactamente qué obtendrías — sin ningún compromiso.',
      formName: 'Nombre Completo',
      formPhone: 'Número de Teléfono',
      formMvp: '¿Te gustaría que construyamos un MVP gratis para tu negocio?',
      mvpExplanation: 'Un MVP (Producto Mínimo Viable) es una versión simplificada de tu sitio web que muestra cómo se vería y funcionaría — construida específicamente para tu negocio. Es completamente gratis y te ayuda a visualizar el resultado final antes de hacer cualquier inversión.',
      mvpYes: '¡Sí, constrúyanme un MVP gratis!',
      mvpNo: 'No por ahora, solo envíenme los resultados',
      submitFinal: 'Enviar',
    },
    thankYou: {
      title: '¡Gracias!',
