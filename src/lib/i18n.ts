...
export const websiteScoreTranslations = {
  en: {
    ...
    results: {
      ...
      estimated: "We couldn't fully analyze your site's technical metrics at this time. The scores shown are industry averages for {businessType} businesses. However, based on your website's visual appearance above, we can already identify significant improvement opportunities.",
      comparisonTitle: 'Your Website vs. A Conversion-Optimized Website',
      yourSite: 'Your Current Site',
      optimizedSite: 'Conversion-Optimized Site',
      comparisonText: "See the difference? Your competitors are already using modern, conversion-focused websites to capture leads. Every day without one is potential revenue walking away.",
  ...
  es: {
    ...
    results: {
      ...
      estimated: 'No pudimos analizar completamente las métricas técnicas de tu sitio en este momento. Los scores mostrados son promedios de la industria para negocios de {businessType}. Sin embargo, basado en la apariencia visual de tu sitio web arriba, ya podemos identificar oportunidades de mejora significativas.',
      comparisonTitle: 'Tu Sitio Web vs. Un Sitio Web Optimizado para Conversión',
      yourSite: 'Tu Sitio Actual',
      optimizedSite: 'Sitio Optimizado para Conversión',
      comparisonText: '¿Ves la diferencia? Tus competidores ya están usando sitios web modernos y enfocados en conversión para captar leads. Cada día sin uno es ingreso potencial que se va.',
