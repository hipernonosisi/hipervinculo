...
export const websiteScoreTranslations = {
  en: {
    ...
    results: {
      ...
      formMvp: 'Want a Free Custom Preview of Your New Website?',
      mvpSteps: [
        { icon: '🎨', text: 'We design your site' },
        { icon: '📱', text: 'You preview it live' },
        { icon: '🚀', text: 'Launch when ready' },
      ],
      mvpExplanation: "Our team will build a working preview of your new website — tailored to your business, brand, and goals. You'll see exactly how it looks and feels before committing to anything. No cost, no obligation.",
      mvpYes: 'Yes! Build my free website preview',
  ...
  es: {
    ...
    results: {
      ...
      formMvp: '¿Quieres una Vista Previa Gratis de Tu Nuevo Sitio Web?',
      mvpSteps: [
        { icon: '🎨', text: 'Diseñamos tu sitio' },
        { icon: '📱', text: 'Lo previsualizas en vivo' },
        { icon: '🚀', text: 'Lanza cuando quieras' },
      ],
      mvpExplanation: 'Nuestro equipo construirá una vista previa funcional de tu nuevo sitio web — adaptada a tu negocio, marca y objetivos. Verás exactamente cómo se ve y se siente antes de comprometerte a nada. Sin costo, sin obligación.',
      mvpYes: '¡Sí! Construyan mi vista previa gratis',
