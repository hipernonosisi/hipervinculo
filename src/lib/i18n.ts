...
export const translations = {
  en: {
    ...
    preview: {
      ...
      hero: {
        headline: 'Stop Losing Customers to Competitors Who Simply Show Up First on Google',
        subheadline: 'We design high-performance websites and run targeted Google Ads that put your business in front of people already searching for your services.',
      ...
      video: {
        tapToWatch: 'Tap to Watch with Sound',
        duration: '9 min · Watch how we grow businesses',
        bookACall: 'Book a Call',
      },
      howWeWork: {
        subtitle: 'How we work?',
        title: 'We simplify growth into 3 focused steps that deliver real results.',
        steps: [
          { label: 'Preview', title: 'We Design Your Website Preview', desc: 'Before you pay a single dollar, we design a custom preview of your new website in just 1 business day. You see exactly what you\'re getting before committing. No commitment, no risk.' },
          { label: 'Build', title: 'We Build & Launch Your Website', desc: 'Not just any website. A high-performance website specifically engineered to convert visitors into customers. Every button, every headline, every page is designed with one goal — make the phone ring. Make the form get filled out. Make the sale happen. This isn\'t about looking pretty. This is about making money.' },
          { label: 'Grow', title: 'We Drive Qualified Traffic', desc: 'We put your business in front of people who are actively searching for your services right now. Not random people scrolling Instagram. People who just typed "plumber near me" or "best dentist in Cancun" into Google. These people have intent, urgency, and a credit card. All they need is to find YOU.' },
          { label: 'Scale', title: 'We Optimize & Scale Your Results', desc: 'Every week, we analyze your campaigns. We track every call, every form submission, every dollar spent and every dollar earned. We kill what doesn\'t work. We double down on what does. Month after month, your lead flow grows, your cost per lead goes down, and your revenue goes up. It\'s a machine — and once it\'s running, it just keeps getting better.' },
        ],
      },
      reviews: {
        title: 'Google Reviews',
        rating: '5.0 (23 reviews)',
        readAll: 'Read All 23 Reviews on Google',
      },
      results: {
        subtitle: 'Explore work',
        title: 'Projects That Speak for Themselves',
        description: 'Live websites you can visit right now. Real businesses generating real revenue.',
        cta: 'Want results like these? Book Your Free Strategy Call',
        caseStudies: [
          { name: 'Step Solution USA', type: 'Manufacturing', result: '+320% increase in qualified dealer leads' },
          { name: 'ZERMA Latin America', type: 'Industrial Machinery', result: '+200% increase in quote requests across LATAM' },
          { name: 'Filtro Láser', type: 'Industrial Equipment', result: 'Full digital presence built & launched in 2 days' },
          { name: 'Pulverizadores Industriales', type: 'Industrial Equipment', result: '50+ qualified leads/year in a highly specialized niche' },
          { name: 'Stillwater Day Spa', type: 'Wellness & Spa', result: 'From 2-3 calls/day to 20+ calls/day' },
          { name: 'Rasetta Innovations', type: 'Interior Design', result: '+180% increase in consultation requests' },
          { name: 'Lajex LLC', type: 'Plumbing & Water Purification', result: '1-2 clients/week to 7-8 clients/week in 90 days' },
          { name: 'Délios Home', type: 'Home Renovation', result: '3 consultation calls booked in first 24 hours' },
        ],
      },
      whyUs: {
        subtitle: 'Why us?',
        title: 'Why 200+ Businesses Trust Us',
        cards: [
          { title: '20+ Years of Experience', desc: 'We\'ve been building websites and running digital campaigns since before most agencies existed.' },
          { title: '200+ Clients Served', desc: 'From local service businesses to international distributors across the US and Latin America.' },
          { title: 'See Before You Pay', desc: 'We design your custom website preview in 1 business day — completely free. No commitment.' },
          { title: 'No Long-Term Contracts', desc: 'We keep clients because we deliver results, not because we lock them into agreements.' },
          { title: 'Real Results, Not Reports', desc: 'We track every call, every form, every dollar. You see exactly what your investment generates.' },
          { title: 'Bilingual Team', desc: 'We serve businesses in English and Spanish across the US, Latin America, and beyond.' },
        ],
      },
      pricing: {
        ...
        ads: {
          ...
          price: '$1,250',
          period: '/month',
          periodDesc: 'ongoing lead generation',
          pause: 'Pause or cancel anytime',
        ...
        footer: 'Every project starts with a free website preview — zero risk.',
      },
      founder: {
        subtitle: 'Meet the Founder',
        title: 'If your business doesn\'t show up on Google... you\'re invisible.',
        p1: 'I\'m Miguel, founder of Hipervínculo. I started this company when I was 21 years old in Venezuela. I was obsessed with the internet, obsessed with what it could do for businesses, and I built my first websites before most people in my country even had a broadband connection. In 2011, I brought the company to the United States, right here to South Florida.',
        p2: 'Over the last 20 years, I\'ve helped more than 200 businesses — from local service companies to international distributors — go from invisible online to generating real customers, real calls, and real revenue. Every single week. Not sometimes.',
        p2Bold: 'Every week.',
      ...
      finalCta: {
        badge: 'Limited availability — only 5 spots this month',
        title1: 'Your Competitors Are Getting the Customers That Should Be',
        titleAccent: 'Yours.',
        description: 'Let\'s fix that. Book a free 15-minute strategy call and see how we\'d build your growth system.',
        cta: 'Book Your Free Strategy Call',
        noPressure: 'No pressure. No hard sell. Just a conversation about your business.',
        stats: [
  ...
  es: {
    ...
    preview: {
      seo: {
        title: 'Haz Crecer Tu Negocio — Hipervínculo',
        description: 'Diseñamos sitios web de alto rendimiento y ejecutamos campañas de Google Ads dirigidas que ponen tu negocio frente a personas que ya están buscando tus servicios.',
      },
      header: {
        bookACall: 'Agenda una Llamada',
      },
      hero: {
        headline: 'Deja de Perder Clientes con Competidores que Simplemente Aparecen Primero en Google',
        subheadline: 'Diseñamos sitios web de alto rendimiento y ejecutamos campañas de Google Ads dirigidas que ponen tu negocio frente a personas que ya están buscando tus servicios.',
        cta1: 'Agenda tu Llamada Estratégica Gratis',
      ...
      video: {
        tapToWatch: 'Toca para Ver con Sonido',
        duration: '9 min · Mira cómo hacemos crecer negocios',
        bookACall: 'Agenda una Llamada',
      },
      howWeWork: {
        subtitle: '¿Cómo trabajamos?',
        title: 'Simplificamos el crecimiento en 3 pasos enfocados que generan resultados reales.',
        steps: [
          { label: 'Preview', title: 'Diseñamos el Preview de Tu Sitio Web', desc: 'Antes de que pagues un solo dólar, diseñamos una vista previa personalizada de tu nuevo sitio web en solo 1 día hábil. Ves exactamente lo que vas a recibir antes de comprometerte. Sin compromiso, sin riesgo.' },
          { label: 'Construir', title: 'Construimos y Lanzamos Tu Sitio Web', desc: 'No cualquier sitio web. Un sitio web de alto rendimiento diseñado específicamente para convertir visitantes en clientes. Cada botón, cada titular, cada página está diseñado con un solo objetivo — hacer que suene el teléfono. Que se llene el formulario. Que se cierre la venta. No se trata de verse bonito. Se trata de generar dinero.' },
          { label: 'Crecer', title: 'Generamos Tráfico Calificado', desc: 'Ponemos tu negocio frente a personas que están buscando activamente tus servicios en este momento. No personas aleatorias navegando en Instagram. Personas que acaban de escribir "plomero cerca de mí" o "mejor dentista en Cancún" en Google. Estas personas tienen intención, urgencia y una tarjeta de crédito. Solo necesitan encontrarte A TI.' },
          { label: 'Escalar', title: 'Optimizamos y Escalamos Tus Resultados', desc: 'Cada semana, analizamos tus campañas. Rastreamos cada llamada, cada formulario, cada dólar gastado y cada dólar ganado. Eliminamos lo que no funciona. Duplicamos lo que sí. Mes tras mes, tu flujo de leads crece, tu costo por lead baja y tus ingresos suben. Es una máquina — y una vez que está funcionando, solo mejora.' },
        ],
      },
      reviews: {
        title: 'Reseñas de Google',
        rating: '5.0 (23 reseñas)',
        readAll: 'Leer las 23 Reseñas en Google',
      },
      results: {
        subtitle: 'Explorar trabajo',
        title: 'Proyectos que Hablan por Sí Mismos',
        description: 'Sitios web en vivo que puedes visitar ahora mismo. Negocios reales generando ingresos reales.',
        cta: '¿Quieres resultados así? Agenda Tu Llamada Estratégica Gratis',
        caseStudies: [
          { name: 'Step Solution USA', type: 'Manufactura', result: '+320% aumento en leads calificados de distribuidores' },
          { name: 'ZERMA Latin America', type: 'Maquinaria Industrial', result: '+200% aumento en solicitudes de cotización en LATAM' },
          { name: 'Filtro Láser', type: 'Equipos Industriales', result: 'Presencia digital completa construida y lanzada en 2 días' },
          { name: 'Pulverizadores Industriales', type: 'Equipos Industriales', result: '50+ leads calificados/año en un nicho altamente especializado' },
          { name: 'Stillwater Day Spa', type: 'Bienestar y Spa', result: 'De 2-3 llamadas/día a 20+ llamadas/día' },
          { name: 'Rasetta Innovations', type: 'Diseño de Interiores', result: '+180% aumento en solicitudes de consulta' },
          { name: 'Lajex LLC', type: 'Plomería y Purificación de Agua', result: 'De 1-2 clientes/semana a 7-8 clientes/semana en 90 días' },
          { name: 'Délios Home', type: 'Renovación de Hogares', result: '3 llamadas de consulta agendadas en las primeras 24 horas' },
        ],
      },
      whyUs: {
        subtitle: '¿Por qué nosotros?',
        title: 'Por Qué 200+ Negocios Confían en Nosotros',
        cards: [
          { title: '20+ Años de Experiencia', desc: 'Hemos construido sitios web y ejecutado campañas digitales desde antes de que la mayoría de las agencias existieran.' },
          { title: '200+ Clientes Atendidos', desc: 'Desde negocios de servicios locales hasta distribuidores internacionales en EE.UU. y Latinoamérica.' },
          { title: 'Mira Antes de Pagar', desc: 'Diseñamos el preview personalizado de tu sitio web en 1 día hábil — completamente gratis. Sin compromiso.' },
          { title: 'Sin Contratos a Largo Plazo', desc: 'Mantenemos clientes porque entregamos resultados, no porque los atamos a acuerdos.' },
          { title: 'Resultados Reales, No Reportes', desc: 'Rastreamos cada llamada, cada formulario, cada dólar. Ves exactamente lo que genera tu inversión.' },
          { title: 'Equipo Bilingüe', desc: 'Atendemos negocios en inglés y español en EE.UU., Latinoamérica y más allá.' },
        ],
      },
      pricing: {
        subtitle: 'Nuestros Precios',
        title: 'Precios Simples y Transparentes',
        description: 'Sin costos ocultos. Sin contratos a largo plazo. Solo resultados.',
        website: {
          title: 'Desarrollo Web',
          price: '$3,000',
          period: 'inversión única',
          pause: 'Pausa o cancela en cualquier momento',
          cta: 'Agenda una Llamada',
          included: 'Qué incluye:',
          features: [
            'Diseño personalizado para tu negocio',
            'Optimizado para móvil y carga rápida',
            'Construido para convertir visitantes en clientes',
            'Estructura lista para SEO',
            'Preview gratuito del sitio web antes de comprometerte',
          ],
        },
        ads: {
          ...
          price: '$1,250',
          period: '/mes',
          periodDesc: 'generación continua de leads',
          pause: 'Pausa o cancela en cualquier momento',
          cta: 'Comienza Hoy',
          included: 'Qué incluye:',
          features: [
            'Campañas dirigidas a tu área de servicio',
            'Solo alcanza personas buscando activamente tus servicios',
            'Optimización y reportes semanales',
            'Seguimiento de conversiones en cada llamada y formulario',
            'Escala a medida que crecen los resultados',
          ],
        },
        footer: 'Cada proyecto comienza con un preview gratuito — cero riesgo.',
      },
      founder: {
        subtitle: 'Conoce al Fundador',
        title: 'Si tu negocio no aparece en Google... eres invisible.',
        p1: 'Soy Miguel, fundador de Hipervínculo. Comencé esta empresa cuando tenía 21 años en Venezuela. Estaba obsesionado con el internet, obsesionado con lo que podía hacer por los negocios, y construí mis primeros sitios web antes de que la mayoría de las personas en mi país tuvieran conexión de banda ancha. En 2011, traje la empresa a Estados Unidos, aquí mismo en el Sur de Florida.',
        p2: 'En los últimos 20 años, he ayudado a más de 200 negocios — desde empresas de servicios locales hasta distribuidores internacionales — a pasar de ser invisibles en línea a generar clientes reales, llamadas reales e ingresos reales. Cada semana. No a veces.',
        p2Bold: 'Cada semana.',
        cta: 'Hablemos de Tu Negocio',
      },
      faq: {
        subtitle: 'Creado para',
        title: 'Preguntas Frecuentes',
        items: [
          { q: '¿Cómo funciona el preview gratuito del sitio web?', a: 'Diseñamos un preview personalizado de tu nuevo sitio web en solo 1 día hábil. Ves exactamente cómo se verá tu sitio antes de pagar nada. Si te encanta, avanzamos. Si no, te vas — sin cargo.' },
          { q: '¿Qué incluye el sitio web de $3,000?', a: 'Un sitio web totalmente personalizado, optimizado para móvil, diseñado para convertir visitantes en clientes. Incluye diseño, desarrollo, configuración de contenido, estructura lista para SEO y lanzamiento.' },
          { q: '¿Qué incluye la gestión de Google Ads de $1,250/mes?', a: 'Estrategia de campaña, creación de anuncios, segmentación de palabras clave, optimización de landing pages, seguimiento de conversiones y optimización semanal. Tu gasto en anuncios con Google es separado y tú controlas el presupuesto.' },
          { q: '¿Necesito firmar un contrato a largo plazo?', a: 'No. Trabajamos mes a mes. Te quedas porque los resultados hablan por sí mismos.' },
          { q: '¿Qué tan pronto veré resultados?', a: 'La mayoría de los clientes ven sus primeros leads calificados dentro de 30-60 días de lanzar Google Ads. Algunos ven resultados en tan solo 2 semanas.' },
          { q: '¿Con qué industrias trabajan?', a: 'Trabajamos con cualquier negocio basado en servicios que tenga un Perfil de Google Business — plomeros, spas, agentes inmobiliarios, dentistas, contratistas, distribuidores y más.' },
        ],
      },
      finalCta: {
        badge: 'Disponibilidad limitada — solo 5 cupos este mes',
        title1: 'Tus Competidores Están Consiguiendo los Clientes que Deberían Ser',
        titleAccent: 'Tuyos.',
        description: 'Arreglemos eso. Agenda una llamada estratégica gratuita de 15 minutos y mira cómo construiríamos tu sistema de crecimiento.',
        cta: 'Agenda Tu Llamada Estratégica Gratis',
        noPressure: 'Sin presión. Sin venta agresiva. Solo una conversación sobre tu negocio.',
        stats: [
          { value: '200+', label: 'Negocios Atendidos' },
          { value: '20+', label: 'Años de Experiencia' },
          { value: '$92M+', label: 'Ingresos Generados' },
        ],
      },
      footer: {
        rights: 'Todos los derechos reservados.',
