...
export const websiteScoreTranslations = {
  en: {
    ...
    results: {
      ...
      formMvp: 'Would you like to see a preview of your new website?',
      mvpExplanation: "We'll design a custom preview of what your new website would look like — built specifically for your business. This helps you visualize the end result before making any decisions.",
      mvpYes: 'Yes, I want to see a preview of my new website',
  ...
  es: {
    ...
    results: {
      ...
      formMvp: '¿Te gustaría ver una vista previa de tu nuevo sitio web?',
      mvpExplanation: 'Diseñaremos una vista previa personalizada de cómo se vería tu nuevo sitio web — creada específicamente para tu negocio. Esto te ayuda a visualizar el resultado final antes de tomar cualquier decisión.',
      mvpYes: 'Sí, quiero ver una vista previa de mi nuevo sitio web',
