...
export const translations = {
  en: {
    ...
    guarantee: {
      ...
      disclaimer: '*This guarantee applies exclusively to our Growth Partner service and does not apply to Lead Generation services.',
      stat: '2.5x',
  ...
  es: {
    ...
    guarantee: {
      ...
      disclaimer: '*Esta garantía aplica exclusivamente a nuestro servicio de Growth Partner y no aplica a los servicios de Generación de Leads.',
      stat: '2.5x',
