...
export default function Index() {
  ...
  return (
    <Layout>
            ...
            <div className="max-w-[620px]">
              ...
              >
                <Button asChild size="lg" className="rounded-full px-8 h-14 text-[16px] font-semibold shadow-lg hover:shadow-xl transition-shadow" style={{ backgroundColor: '#8BC34A', color: 'white' }}>
                  <Link to="/preview">{language === 'en' ? 'Free Website Preview' : 'Vista Previa Gratis'} <ArrowRight className="ml-2 h-5 w-5" /></Link>
                </Button>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container">
          <AnimatedSection className="flex flex-col items-center justify-center gap-4">
            ...
            <a
              ...
              className="text-muted-foreground hover:text-foreground underline underline-offset-4 text-[15px] md:text-[16px] transition-colors flex items-center gap-1"
            >
              {language === 'es' ? 'Ver nuestras reseñas en Google' : 'See our reviews on Google'} →
            </a>
          </AnimatedSection>
        </div>
      </section>
