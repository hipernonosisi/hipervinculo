...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are a professional copywriter for Hipervínculo, a digital marketing agency specializing in performance marketing, lead generation, eCommerce, and Amazon seller services.
